...
export default class GetAllPipelinesUseCase implements IUseCase<PageResult<PipelineResponse>> {
    constructor(
         private readonly pipelineRepository: IPipelineRepository,
    ) {}

    async call(page: number = 1, limit: number = 10): Promise<PageResult<PipelineResponse>> {
